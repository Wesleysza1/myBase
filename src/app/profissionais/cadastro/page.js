        ...
        <Grid item xs={12} md={6}>
          ...
          >
            <Typography
              variant="h5"
              gutterBottom
              sx={{ color: "#ffffff", textAlign: 'center', fontFamily: '"Audiowide", "system-ui"' }}>
              Seja Nosso Freela!!
            </Typography>
            <form onSubmit={handleSubmit}>
                ...
                sx={{
                  '& .MuiOutlinedInput-root': {
                    ...
                    '&.Mui-focused fieldset': {
                      borderColor: '#000000', // Borda preta quando focada
                    },
                  },
                }}
              />
              ...
              <FormControl fullWidth margin="normal" required error={erros.profissao}>
                <InputLabel sx={{ color: "#000000" }}>Profissão</InputLabel>
                <Select
                  multiple
                  ...
                  MenuProps={{
                    PaperProps: {
                      sx: {
                        backgroundColor: '#000000', // Background preto dentro da caixa de seleção
                        color: '#ffffff', // Texto branco dentro da caixa
                      },
                    },
                  }}
                >
                  {profissoes.map((profissao) => (
                    <MenuItem key={profissao} value={profissao} sx={{ color: "#ffffff" }}>
              ...
              <FormControl fullWidth margin="normal">
                <InputLabel sx={{ color: "#000000" }}>País</InputLabel>
                <Select
                  value={formData.pais}
                ...
                >
                  {Object.keys(paises).map((pais) => (
                    <MenuItem key={pais} value={pais} sx={{ color: "#ffffff" }}>
                      {pais}
                    </MenuItem>
                  ))}
                </Select>
              ...
              <FormControl fullWidth margin="normal">
                <InputLabel sx={{ color: "#000000" }}>Cidade</InputLabel>
                <Select
                ...
                >
                  {cidadesDisponiveis.map((cidade) => (
                    <MenuItem key={cidade} value={cidade} sx={{ color: "#ffffff" }}>
                      {cidade}
                    </MenuItem>
                  ))}
                </Select>
              ...
              <Box display="flex" alignItems="center" mt={2}>
                <Typography variant="body1" sx={{ mr: 1, color: "#000000" }}>
                  Possui CNPJ ou MEI?
                </Typography>
                <RadioGroup
                  row
                  ...
                  onChange={handleChange}
                >
                  <FormControlLabel style={{ color: "#000000" }} value="Sim" control={<Radio sx={{ color: "#000000", '&.Mui-checked': { color: "#000000" } }} />} label="Sim" />
                  <FormControlLabel style={{ color: "#000000" }} value="Não" control={<Radio sx={{ color: "#000000", '&.Mui-checked': { color: "#000000" } }} />} label="Não" />
                </RadioGroup>
              </Box>
              ...
              <Typography variant="body2" align="center" sx={{ color: "#ffffff", mt: 2 }}>
                Ao fornecer seus dados pessoais, você concorda com nossa{' '}
                <Link href="/documentos/politica-privacidade" target="_blank" sx={{ color: "#000000" }}>
